...
namespace JWTApiNet.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        // domain.com/api/user/register
        [Route("register")]
        [AllowAnonymous]
        [HttpPost]
        public async Task<IActionResult> Register([FromBody] User user)
        {
            string username = user.EmailAdresse;
            ...
            {
                string errorsToReturn = "Register Fails with the following Errors ";
